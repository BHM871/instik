<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    $config['grocery_crud_default_language'] = 'portuguese-brazilian';
    ...
    $config['grocery_crud_file_upload_max_file_size'] = '50MB'; //eg. '10MB' (Mega Bytes), '1067KB' (Kilo Bytes), '5000B' (Bytes)
